...
public class BooksAndTopicsSpringService
    ...
    @Autowired
    private DataManagerAppUser dataManagerAppUser;
    ...
    public List<AppUser> getAllAppUsers() {
        return this.dataManagerAppUser.getAppUsers().stream()
                .map(e -> this.appUserDtoBoMapper.toDto(e))
                .collect(Collectors.toList());
    }

    public AppUser getAppUser(final Long id) {
        return this.appUserDtoBoMapper.toDto(
                this.dataManagerAppUser.getAppUser(id));
    }

    public void addAppUser(final AppUser appUser) {
        this.dataManagerAppUser.addAppUser(
                this.appUserDtoBoMapper.toBo(appUser));
    }

    public void updateAppUser(final AppUser appUser,
                              final Long id) {
        this.dataManagerAppUser.updateAppUser(
                this.appUserDtoBoMapper.toBo(appUser), id);
    }

    public void deleteAppUser(final Long id) {
        this.dataManagerAppUser.deleteAppUser(id);
    }
