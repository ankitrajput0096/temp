...
public class BooksSpringController {
    ...
    public ResponseEntity<List<AppUser>> listOfAppUsers() {
        return ResponseEntity.ok().body(this.booksAndTopicsSpringService
                .getAllAppUsers());
    }
    ...
    @RequestMapping(
            value = "/AppUsers",
            method = RequestMethod.POST)
    public ResponseEntity<String> addAppUser(
            @RequestBody AppUser appUser) {
        this.booksAndTopicsSpringService.addAppUser(appUser);
        return ResponseEntity.status(HttpStatus.CREATED)
                .body("the new AppUser is created with details :" +
                        appUser.toString());
    }
    ...
    @RequestMapping(
            value = "/AppUsers/{id}",
            method = RequestMethod.PUT)
    public ResponseEntity<String> updateAppUser(
            @RequestBody AppUser appUser,
            @PathVariable Long id) {
        this.booksAndTopicsSpringService.updateAppUser(appUser, id);
        return ResponseEntity.status(HttpStatus.FOUND)
                .body("the existing AppUser is updated with details :" +
                        appUser.toString());
    }
    ...
    public ResponseEntity<String> deleteAppUser(@PathVariable Long id) {
        this.booksAndTopicsSpringService.deleteAppUser(id);
        return ResponseEntity.ok()
                .body("the AppUser is successfully deleted with id : " + id);
    }

    //---------------------- Api's to test @Transaction annotation ------------

    @RequestMapping(value = "/transaction/scenario-one")
    ...
    @RequestMapping(value = "/transaction/scenario-two")
    ...
    @RequestMapping(value = "/transaction/scenario-three")
    ...
    @RequestMapping(value = "/transaction/scenario-four")
