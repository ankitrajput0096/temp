...
public interface BooksAndTopicsSpringIface {
    ...
    void transactionTwo() throws Exception;

    void transactionThree();

    void transactionFour() throws Exception;

    List<AppUser> getAllAppUsers();

    AppUser getAppUser(final Long id);

    void addAppUser(final AppUser appUser);

    void updateAppUser(final AppUser appUser, final Long id);
